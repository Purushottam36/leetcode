...
🔴 **Hard** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/insert-delete-getrandom-o(1)---duplicates-allowed/)
...
**My Solution:** [381-Insert-Delete-GetRandom-O(1)---Duplicates-allowed.py](./381-Insert-Delete-GetRandom-O(1)---Duplicates-allowed.py)
