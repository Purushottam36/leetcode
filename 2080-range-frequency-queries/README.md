...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/range-frequency-queries/)
...
**My Solution:** [2080-Range-Frequency-Queries.py](./2080-Range-Frequency-Queries.py)
