...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/count-partitions-with-even-sum-difference/)
...
**My Solution:** [3432-Count-Partitions-with-Even-Sum-Difference.java](./3432-Count-Partitions-with-Even-Sum-Difference.java)
